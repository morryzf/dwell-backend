...
不会一次读完整本。自动阅读默认关闭，可以在书房里设置每天的阅读时段与次数，也可以临时让他现在去读一会儿。

Cloudy 的私人读书笔记只作为他下次继续阅读的上下文，不在界面展示。「想和小猫分享的」是另一册本子：
Cloudy 有真正想分享的想法或问题时会写一页，用户可以留言；Cloudy 下次进入书房后才会看到并决定如何回复。
